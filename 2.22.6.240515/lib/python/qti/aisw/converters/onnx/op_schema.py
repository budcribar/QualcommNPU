...
from qti.aisw.converters.onnx.util import OnnxAttrProtoUtil, extract_onnx_type
import copy
...
def check_attribute_type(attribute, src_op_attr):
    snpe_type = OnnxAttrProtoUtil.strCode_to_enum[str(attribute[1])]
...
def parse_attributes(attribute):
    ...
    for key, value in OnnxAttrProtoUtil.strCode_to_enum.items():
