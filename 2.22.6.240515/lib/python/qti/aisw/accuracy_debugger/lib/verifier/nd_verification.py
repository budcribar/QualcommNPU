...
from qti.aisw.accuracy_debugger.lib.utils.nd_verifier_utility import permute_tensor_data_axis_order, save_to_file
                ...
                for i in range(len(golden_tensors)):
                    ...
                    if golden_tensor_name in self.qnn_model_tensors_json:
                        ...
                        golden_data[i], _ = permute_tensor_data_axis_order(
                            src_axis_format, axis_format, tensor_dims, golden_data[i])
