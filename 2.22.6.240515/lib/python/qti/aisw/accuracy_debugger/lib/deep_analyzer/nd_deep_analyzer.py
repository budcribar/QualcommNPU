...
class DeepAnalyzer:
    ...
    def __init__(self, args, logger):
        ...
        if args.deep_analyzer is None:
            raise DeepAnalyzerError(
                get_message('ERROR_DEEP_ANALYZER_INVALID_ANALYZER_NAME')(args.deep_analyzer))
    ...
    def run_model_dissection_analyzer(self, summary_df):
        modelDissectionAnalyzer = ModelDissectionAnalyzer(summary_df, self.config, self.logger,
                                                          self.envToolConfig)
    ...
    def analyze(self):
        ...
        if analyzerName == "modeldissectionanalyzer":
            ...
            raise DeepAnalyzerError(
                get_message('ERROR_DEEP_ANALYZER_INVALID_ANALYZER_NAME')(self.analyzer_name))
