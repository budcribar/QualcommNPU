...
class GraphStructure:
    ...
    class Component:
        """Component represents either an op for a framework (such as
        Tensorflow) or a layer for an engine (such as SNPE) alogn with their
    ...
    def __init__(self, graph_structure):
        """Instantiation of GraphStructure should be done through
    ...
    def _initialize(self, graph_structure):
        ...
        self._components = [
            GraphStructure.Component(key, info) for key, info in graph_structure.items()
        ]
    ...
    def save_graph_structure(graph_file, graph_struct):
        ...
        :param graph_struct: OrderedDict of op/layer name to list of two
