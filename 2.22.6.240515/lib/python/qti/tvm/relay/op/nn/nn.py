...
### [QTI Change]
def pad(data, pad_width, pad_value=0, pad_mode="constant", data_layout=""):
    r"""Padding
    ...
    QTI Parameters
    -------
        data_layout: 'NCDHW', 'NCHW', 'NCW', 'NHWC', ...
        'NCDHW'/'NCHW'/'NCW' default data_layout for Onnx/Pytorch frontend
        'NDHWC'/'NHWC'/'NWC' default data_layout for TFLite frontend
        If ConvertLayout Pass is applied, data_layout has to be set based on data rank.
        For example, onnx pad Op's data_layout will be set according to its input rank in onnx.py
    ...
    if isinstance(pad_width, Expr):
        return _dyn_make.pad(data, pad_width, pad_value, pad_mode, data_layout)
    return _make.pad(data, pad_width, pad_value, pad_mode, data_layout)
### [End QTI Change]
