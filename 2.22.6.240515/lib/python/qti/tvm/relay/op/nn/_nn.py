...
# [QTI Change]
@reg.register_convert_op_layout("nn.max_pool1d")
def convert_max_pool1d(attrs, inputs, tinfos, desired_layouts):
    """Convert Layout pass registration for max_pool1d op.
    Parameters
    ----------
    attrs : tvm.ir.Attrs
    ...
    return relay.nn.max_pool1d(*inputs, **new_attrs)
# [End QTI Change]
...
# [QTI Change]
@reg.register_convert_op_layout("nn.max_pool3d")
def convert_max_pool3d(attrs, inputs, tinfos, desired_layouts):
    """Convert Layout pass registration for max_pool3d op.
    Parameters
    ----------
    attrs : tvm.ir.Attrs
        Attributes of current pooling
    ...
    new_attrs = dict(attrs)
    new_attrs["layout"] = str(desired_layouts[0])
    return relay.nn.max_pool3d(*inputs, **new_attrs)
# [End QTI Change]
...
# [QTI Change]
@reg.register_convert_op_layout("nn.avg_pool1d")
def convert_avg_pool1d(attrs, inputs, tinfos, desired_layouts):
    """Convert Layout pass registration for avg_pool1d op.
    Parameters
    ----------
    attrs : tvm.ir.Attrs
        Attributes of current pooling
    ...
    new_attrs = dict(attrs)
    new_attrs["layout"] = str(desired_layouts[0])
    return relay.nn.avg_pool1d(*inputs, **new_attrs)
# [End QTI Change]
...
# [QTI Change]
@reg.register_convert_op_layout("nn.avg_pool3d")
def convert_avg_pool3d(attrs, inputs, tinfos, desired_layouts):
    """Convert Layout pass registration for avg_pool3d op.
    Parameters
    ----------
    attrs : tvm.ir.Attrs
        Attributes of current pooling
    ...
    new_attrs = dict(attrs)
    new_attrs["layout"] = str(desired_layouts[0])
    return relay.nn.avg_pool3d(*inputs, **new_attrs)
# [End QTI Change]
...
# [QTI Change]
@reg.register_convert_op_layout("nn.adaptive_max_pool1d")
def convert_adaptive_max_pool1d(attrs, inputs, tinfos, desired_layouts):
    """Convert Layout pass registration for adaptive_max_pool1d op.
    Parameters
    ----------
    attrs : tvm.ir.Attrs
        Attributes of current pooling
    ...
    new_attrs = dict(attrs)
    new_attrs["layout"] = str(desired_layouts[0])
    return relay.nn.adaptive_max_pool1d(*inputs, **new_attrs)
# [End QTI Change]
...
@reg.register_convert_op_layout("nn.adaptive_max_pool2d")
def convert_adaptive_max_pool2d(attrs, inputs, tinfos, desired_layouts):
    """Convert Layout pass registration for adaptive_max_pool2d op.
    Parameters
    ----------
    attrs : tvm.ir.Attrs
        Attributes of current pooling
    ...
    new_attrs = dict(attrs)
    new_attrs["layout"] = str(desired_layouts[0])
    return relay.nn.adaptive_max_pool2d(*inputs, **new_attrs)
...
# [QTI Change]
@reg.register_convert_op_layout("nn.adaptive_max_pool3d")
def convert_adaptive_max_pool3d(attrs, inputs, tinfos, desired_layouts):
    """Convert Layout pass registration for adaptive_max_pool3d op.
    Parameters
    ----------
    attrs : tvm.ir.Attrs
        Attributes of current pooling
    ...
    new_attrs = dict(attrs)
    new_attrs["layout"] = str(desired_layouts[0])
    return relay.nn.adaptive_max_pool3d(*inputs, **new_attrs)
# [End QTI Change]
...
# [QTI Change]
@reg.register_convert_op_layout("nn.adaptive_avg_pool3d")
def convert_adaptive_avg_pool3d(attrs, inputs, tinfos, desired_layouts):
    """Convert Layout pass registration for adaptive_avg_pool3d op.
    Parameters
    ----------
    attrs : tvm.ir.Attrs
        Attributes of current pooling
    ...
    new_attrs = dict(attrs)
    new_attrs["layout"] = str(desired_layouts[0])
    return relay.nn.adaptive_avg_pool3d(*inputs, **new_attrs)
# [End QTI Change]
