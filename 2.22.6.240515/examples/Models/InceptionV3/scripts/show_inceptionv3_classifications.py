...
def main():
    parser = argparse.ArgumentParser(description='Display Inceptionv3 classification results.')
    ...
    if len(input_files) <= 0:
        ...
        for idx, val in enumerate(input_files):
            ...
            cur_results_file = os.path.join(output_dir, cur_results_dir, 'InceptionV3_Predictions_Reshape_1_0.raw')
