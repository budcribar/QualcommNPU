...
class TensorFlowFramework_1_15_0(BaseFramework):
        ...
        with tf.Session(graph=self._graph) as sess:
            for data, tensor_name in zip(input_data, input_tensor_names):
                ...
                if tensor.get_shape().dims is not None:
                    ...
                    self.logger.warning(get_warning_message("WARNING_FRAMEWORK_TENSORFLOW_DIMENSION_UNSPECIFIED"))
    ...
    def get_intermediate_tensors(self, input_tensors, output_tensors):
        ...
        ops = tf.contrib.graph_editor.get_walks_intersection_ops(input_ops, output_ops, forward_inclusive=False, backward_inclusive=True, control_inputs=False)
    ...
    def get_mapping_for_qnn_node(self, qnn_output):
        ...
        self.logger.warning(get_warning_message("WARNING_FRAMEWORK_TENSORFLOW_MISMATCH_TENSOR")(qnn_output))
        return " "
